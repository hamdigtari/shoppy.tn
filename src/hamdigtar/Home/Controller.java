...
public class Controller  implements Initializable{
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        pane1.setStyle("-fx-background-image: url(\"/hamdigtar/Home/1.png\")");
        pane2.setStyle("-fx-background-image: url(\"/hamdigtar/Home/4.jpg\")");
        pane3.setStyle("-fx-background-image: url(\"/hamdigtar/Home/3.png\")");
        pane4.setStyle("-fx-background-image: url(\"/hamdigtar/Home/4.png\")");
